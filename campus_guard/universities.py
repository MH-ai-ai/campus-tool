...
_DEFAULT_PROFILES: list[dict[str, Any]] = [
    {
        "id": "yau",
        "name": "延安大学 (默认 · Dr.COM)",
        "pinyin": "yanandaxue yau ydy",
        "protocol": "drcom",
        "auth_url": "http://10.212.0.1:801/eportal/index.jsp",
        "gateway": "10.212.0.1",
        "ac_ip": "",
        "wifi_ssids": ["YAU", "YAU_5G", "i-YAU"],
        "domain_keywords": ["10.212.0.1", "yau.edu.cn"],
        "description": "延安大学新校区/杨家岭校区 Dr.COM ePortal 校园网",
    },
    {
        "id": "generic_drcom",
