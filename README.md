...
### 选项 A：直接下载绿色便携版（推荐）
1. 前往 [**Releases 发行版页面**](https://github.com/MH-ai-ai/campus-tool/releases) 下载最新的 `CampusGuard-v2.0.1-Windows-x64.zip`；
...
本项目采用 MIT 许可证。特别致敬延安大学（Yan'an University）校园网络开发与测试支持。
